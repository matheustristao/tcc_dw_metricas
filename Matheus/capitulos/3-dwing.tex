...
\begin{easylist}[itemize]
	...
	& \textbf{\textit{Rol Up:}} Ao contrário da operação \textit{Drill Down}, a \textit{Roll Up} parte de um nível mais detalhado para um nível menos detalhado  \cite{neeraj_sharma_2011}.
...
A imagem \ref{fig:drill}, extraída do do livro \textit{Getting Started With Data Warehousing}, do autor \cite{neeraj_sharma_2011}, mostra o fluxo percorrido pelo \textit{Drill Down} e \textit{Drill Up}:
