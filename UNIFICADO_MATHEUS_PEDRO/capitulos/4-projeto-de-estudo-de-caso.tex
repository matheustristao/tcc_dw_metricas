...
Uma vantagem dos estudos de caso encontra-se no fato deles serem mais fáceis de serem planejado, além de possuírem maior caráter realista, porém as desvantagens esbarram no fato dos resultados serem mais difíceis de interpretar e generalizar, ou seja, é possível mostrar os efeitos de uma situação típica, porém é necessária maior análise para que se possa generalizar a outras situações \cite{wohlin2012experimentation}.
