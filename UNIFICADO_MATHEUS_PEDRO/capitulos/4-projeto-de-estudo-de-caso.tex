...
Buscando obedecer os requisitos já citados sobre como um problema deve ser, bem como os fatos citados na seção \ref{intro_problema} o seguinte problema foi formulado:

\textbf{\textit{Dificuldade em interpretar dados numéricos a respeito da qualidade do código fonte, fator essencial na tomada de decisão quanto a refatoração.}}

\subsection{Questão de Pesquisa}

Segundo \citeonline{caldiera_goal_1994}, a questão de pesquisa deve ser capaz de caracterizar o objeto que está sendo medido, seja ele produto, processo ou recurso. Sob essa lógica, e levando em conta a análise do problema identificado, a seguinte questão de pesquisa relacionada ao processo de monitoramento de métricas de código fonte foi criada:
