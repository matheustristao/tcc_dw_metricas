...
Outros trabalhos relacionados ao conceito de métricas de software utilizados nessa revisão são \citeonline{Sommerville10}, \citeonline{Fenton98}, \citeonline{pandian_software_2004}, \citeonline{metricsandmodels}, \citeonline{McCabe76}, \citeonline{pressman_engenharia_2010}. Outros trabalhos que possuem como tema \textit{data warehousing} foram utilizados durante a revisão bibliográfica, entre eles estão  \citeonline{Inmon2002}, \citeonline{Kimball2002}, \citeonline{chaudhuri1997}. 
...
\begin{tabular}{|l|l|l|}
\hline
\textbf{Atividade}                        & \textbf{Mês de Início} & \textbf{Mês de Témino} \\ \hline
Estudo Estatístico                        & Janeiro                & Fevereiro              \\ \hline
Análise da Taxa                           & Janeiro                & Fevereiro              \\ \hline
Revisão e Adequação                       & Janeiro                & Janeiro                \\ \hline
Formalização com as Instituições          & Fevereiro              & Fevereiro              \\ \hline
Reunião para Definição Dos Encontros      & Fevereiro              & Fevereiro              \\ \hline
Instalação do Ambiente                    & Fevereiro              & Fevereiro              \\ \hline
Coleta de Dados                           & Março                  & Junho                  \\ \hline
Análise dos Dados                         & Maio                   & Junho                  \\ \hline
Redação do Relatório                      & Maio                   & Junho                  \\ \hline
Revisão dos Resultados                    & Junho                  & Junho                  \\ \hline
Revisão Final do Trabalho                 & Junho                  & Junho                  \\ \hline
Entrega Final                             & Junho                  & Junho                  \\ \hline
Elaboração da Apresentação para a Defesa  & Junho                  & Junho                  \\ \hline
Preparação com o Orientador para a Defesa & Junho                  & Junho                  \\ \hline
Apresentação do Trabalho em Banca         & Junho                  & Junho                  \\ \hline
\end{tabular}
\end{table}
