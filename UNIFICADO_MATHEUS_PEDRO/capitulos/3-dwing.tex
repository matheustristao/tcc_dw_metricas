...
São vários os tipos de aplicação aceitos para um data warehouse. Algumas delas serão definidas a seguir.
...
Seguindo a metodologia de \citeonline{Kimball2002} para projetar um data warehouse,  o projeto de \citeonline{rego_monitoramento_2014} para a solução de \textit{data warehousing} para métricas de código-fonte seguiu os passos da metodologia, definidos em cada sub-seção a seguir.
...
Utilizando a ferramenta MySql Workbench, \citeonline{rego_monitoramento_2014} elaborou o seguinte modelo físico baseado nos fatos e dimensões já identificados:
