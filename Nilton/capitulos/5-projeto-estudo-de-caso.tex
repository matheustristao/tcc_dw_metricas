...
\citeonline{novello_uma_2006} utilizou \textit{Data Warehouse} para monitoramento de métricas no processo de desenvolvimento de software, porém são métricas voltadas para a qualidade do processo de desenvolvimento de software mas são diretamente relacionadas ao código-fonte. 


Já no trabalho de \citeonline{Ruiz2005} foi apresentado um ambiente de \textit{Data Warehousing} para apoiar a implementação de um programa de medição em uma organização certificada como CMM Nível 2, também foi concebido um experimento que valida sua arquitetura, onde foi usado dados organizacionais reais. \citeonline{Ruiz2005} aborda três aspectos essenciais: 
...
\textcolor{red}{\todo[inline, color=yellow!20]{Ao ler o txto não fica claro a explicação da tabela 15 e dos bullets abaixo dela. Reescrever.}}
...
\textcolor{red}{\todo[inline, color=yellow!20]{Dê uma olhada nas considerações que fiz no trabalho do Matheus e Pedro. A descrição posta aqui não reflete bem os elementos da validade de construção. está um pouco confuso}}
...
\textcolor{red}{\todo[inline, color=yellow!20]{Está igual a do Matheus e Pedro... Verificar também as considerações que fiz no deles.}}
